...
; ----------------
; Lem E. Tweakit formulas for parallel resistors
...
; Original behaviour according to Lem's complain

;(define res1 (make-center-percent 12 .25))
;(define res2 (make-center-percent 3 .33))
;(define p1 (par1 res1 res2))
;(define p2 (par2 res1 res2))

;(print-cp p1)
;2.4000738091622438 ± .8459821633343275 %

;(print-cp p2)
;2.3999997542382614 ± .31400005939242404 %

;Part A: Lem is right, the results are different
