...
(define i1 (make-center-percent 3 .2))
(define i2 (make-center-percent 2 .1))
(define i3 (mul-interval i1 i2))
(percent i3)
;Value: .2999994000011892

(define i1 (make-center-percent 134562 .123))
(define i2 (make-center-percent 123123 .456))
(define i3 (mul-interval i1 i2))
(percent i3)
;Value: .5789967525230132


; For smal percent tolerances:
; - The percent tolerance of the product is the sum of the tolerance of the factors