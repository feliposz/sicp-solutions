...
;TODO: Find a way to read a binary file and fill the image structure with
;      the binary data read from it.
 
;(graphics-operation gdev 'load-bitmap "Felipo2.bmp")
;(define image (graphics-operation gdev 'create-image 50 50))

;(define felipo2 (open-binary-input-file "Felipo2.bmp"))

;1178

;(read-substring felipo2 f2data 1178 3678)
