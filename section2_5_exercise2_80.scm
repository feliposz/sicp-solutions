...
(apply-generic '=zero? (make-scheme-number 3))
(apply-generic '=zero? (make-scheme-number 0))
(display "Rationals:") (newline)
(apply-generic '=zero? (make-rational 1 2))
(apply-generic '=zero? (make-rational 0 2))
(display "Complex:") (newline)
(apply-generic '=zero? (make-from-real-imag 1 2))
(apply-generic '=zero? (make-from-mag-ang 3 1))
(apply-generic '=zero? (make-from-real-imag 0 2))
(apply-generic '=zero? (make-from-mag-ang 0 1))
